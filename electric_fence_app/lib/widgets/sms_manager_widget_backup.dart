            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('• Method: Automatic SMS via Twilio'),
                  const SizedBox(height: 8),
                  const Text(
                    'Note: SMS will be sent automatically to configured phone numbers.',
                    style: TextStyle(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: twilioConfigured ? Colors.green : Colors.red,
                  fontWeight: FontWeight.bold,
                ),
              ),
            ),
